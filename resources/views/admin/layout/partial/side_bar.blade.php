            ...
            <ul class="navbar-nav flex-column" id="navbar-sidebar">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav collapse flex-column" id="collapsepage" data-bs-parent="#navbar-sidebar">
                        ...
                        <li class="nav-item"><a class="nav-link" href="admin-course-category.html">Course
                                Category</a></li>
                        <li class="nav-item"><a class="nav-link" href="admin-course-detail.html">Course Detail</a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav collapse flex-column" id="collapseinstructors" data-bs-parent="#navbar-sidebar">
                        <li class="nav-item"><a class="nav-link" href="admin-instructor-list.html">Instructors</a>
                        </li>
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav collapse flex-column" id="collapseauthentication"
                        ...
                        <li class="nav-item"><a class="nav-link" href="forgot-password.html">Forgot Password</a>
                        </li>
